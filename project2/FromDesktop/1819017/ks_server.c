...
void search_file(char *path, char *key, char *name, FILE *fp_out)
{
    ...
    //key1, 2, 3 used for three possible cases of key
    strcat(nkey1, key);
    strcat(nkey1, " ");
...
void search_dir(char *key, char *dir, FILE *fp_out)
{
    ...
    //ignore "." and ".." since no subfolders will be present
...
int main(void)
{
    ...
    while(1) //runs forever until "exit" is passed in as an argument.
    {
